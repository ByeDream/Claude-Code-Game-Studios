 ...
 *
 * Sprint 2: Roguelike Run Loop with map, node interactions, and battle.
 * Previous Sprint 1 battle prototype is still accessible via tab toggle.
 */
...
type AppMode = 'run' | 'battle'

function App() {
  const [mode, setMode] = useState<AppMode>('run')
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...tabStyle,
            borderBottom: mode === 'run' ? '2px solid #e74c3c' : '2px solid transparent',
            color: mode === 'run' ? '#e6edf3' : '#8b949e',
          }}
        >
          🗺️ 肉鸽征途
        </button>
        <button
          ...
          style={{
            ...tabStyle,
            borderBottom: mode === 'battle' ? '2px solid #e74c3c' : '2px solid transparent',
            color: mode === 'battle' ? '#e6edf3' : '#8b949e',
          }}
        >
          ⚔️ 战斗原型
        </button>
